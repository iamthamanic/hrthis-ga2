...
const NextEventProgress: React.FC<{ nextEvent: any; userBalance: number }> = ({ nextEvent, userBalance }) => {
...
const getProgressContent = (nextEvent: any, unlockedEvents: any[], allEvents: any[], userBalance: number) => {
  if (nextEvent) {
